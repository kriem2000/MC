    ...
    <div class="flex-lg-row-fluid ms-lg-7 ms-xl-10">
        ...
        <div class="card" id="kt_chat_messenger">
                        ...
                        <div class="d-flex justify-content-start mb-10">
                            ...
                            <div class="d-flex flex-column align-items-start">
                                ...
                                <div class="p-5 rounded bg-light-info text-dark fw-bold mw-lg-400px text-start" data-kt-element="message-text">
                                    {{ $message->content }}
                                    @if ($message->attachment )
                                        <a class="btn btn-sm btn-icon btn-active-light-info me-1" href="{{ $message->attachment}}" type="button" data-bs-toggle="tooltip" title="" data-bs-original-title="{{ $message->attachment }}">
                                            <i class="bi bi-paperclip fs-3"></i>
                                        </a>
                                    @endif
                                </div>
            ...
            <div class="card-footer pt-4" id="kt_chat_messenger_footer">
               ...
               <form action="{{ route('MessageController', [$consultation_id,$doctor_id] ) }}" method="POST"  enctype="multipart/form-data"  novalidate="novalidate" id="kt_MessageController_form" >
                  @csrf
              <!--begin::Input-->
